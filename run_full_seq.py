...
from motsynth import MOTSynth, MOTSynthBlackBG, MOTSynthWholeSec
...
train_data = MOTSynthWholeSec(data_dir, train=True)

train_loader = DataLoader(
    train_data, batch_size=args.batch_size, shuffle=False, num_workers=args.workers, drop_last=True)
...
args.last_ckpt = './model_gradient/ckpt_epoch_13600.pth'
...
with open('example_viz/preds_gradient.pickle', 'wb') as handle:
